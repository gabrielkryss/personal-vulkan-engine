...
void vkLogging::Logger::set_debug_mode(bool mode) { debugMode = mode; }

bool vkLogging::Logger::get_debug_mode() { return debugMode; }
...
/*
                ...
                void log_surface_capabilities(vk::SurfaceCapabilitiesKHR
   surfaceCapabilities); void log_surface_format(vk::SurfaceFormatKHR
   surfaceFormat); private: std::array<int, 4> extract_version_number;
                ...
                void log_physical_device_limits(vk::PhysicalDeviceLimits
   limits); std::vector<std::string>
   log_transform_bits(vk::SurfaceTransformFlagsKHR bits);
                std::vector<std::string>
   log_alpha_composite_bits(vk::CompositeAlphaFlagsKHR bits);
                std::vector<std::string>
   log_image_usage_bits(vk::ImageUsageFlags bits); std::string
   log_present_mode(vk::PresentModeKHR presentMode); bool debugMode;
*/
 ...
 */
std::vector<std::string>
vkLogging::log_transform_bits(vk::SurfaceTransformFlagsKHR bits) {
  ...
  /*
     ...
     0x00000020, VK_SURFACE_TRANSFORM_HORIZONTAL_MIRROR_ROTATE_180_BIT_KHR =
     0x00000040, VK_SURFACE_TRANSFORM_HORIZONTAL_MIRROR_ROTATE_270_BIT_KHR =
     0x00000080, VK_SURFACE_TRANSFORM_INHERIT_BIT_KHR = 0x00000100, }
...
std::vector<std::string>
vkLogging::log_alpha_composite_bits(vk::CompositeAlphaFlagsKHR bits) {
  std::vector<std::string> result;
 ...
 */
std::vector<std::string>
vkLogging::log_image_usage_bits(vk::ImageUsageFlags bits) {
  std::vector<std::string> result;
...
vkLogging::make_debug_messenger(vk::Instance &instance,
  ...
  * DebugUtilsMessengerCreateInfoEXT(
  ...
  messageSeverity_ = {}, VULKAN_HPP_NAMESPACE::DebugUtilsMessageTypeFlagsEXT
