...
void vkImage::copy_buffer_to_image(BufferImageCopyJob copyJob) {
  ...
  */
  ...
  copy.imageExtent = vk::Extent3D(copyJob.width, copyJob.height, 1.0f);

  copyJob.commandBuffer.copyBufferToImage(copyJob.srcBuffer, copyJob.dstImage,
...
vk::ImageView vkImage::make_image_view(vk::Device logicalDevice,
  ...
  * ImageViewCreateInfo( VULKAN_HPP_NAMESPACE::ImageViewCreateFlags flags_ = {},
  ...
  VULKAN_HPP_NAMESPACE::ImageViewType::e1D, VULKAN_HPP_NAMESPACE::Format format_
