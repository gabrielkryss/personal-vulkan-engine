...
vkInit::make_descriptor_set_layout(vk::Device device,
...
vk::DescriptorPool
vkInit::make_descriptor_pool(vk::Device device, uint32_t size,
                             const descriptorSetLayoutData &bindings) {
...
vk::DescriptorSet
vkInit::allocate_descriptor_set(vk::Device device,
